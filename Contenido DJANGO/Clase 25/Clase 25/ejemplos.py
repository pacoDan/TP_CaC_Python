...
longitud = len(cadena1) # 32
elem     = len(lista1)  # 4

cuenta = cadena1.count('yama') #1, cuenta apariciones de 'yama'
print(cadena1.find('yama'))    #10, devuelve posición de búsqueda

cadena2 = cadena1.join('***')  #*tengo una yama que Yama se llama*tengo una yama que Yama se llama*
lista1  = cadena1.split(' ')    #divide cadena por separador → lista
tupla1  = cadena1.partition(' ')#Devuelve la string antes del primer separador, el separador y lo restante por otro lado

cadena2 = cadena1.replace('yama','cabra',1) #tengo una cabra que Yama se llama
...
cadena5 = "  abc;123  " #declara variable con cadena alfanumérica
...
print(cadena6.capitalize()) #Capitaliza: "Mar"

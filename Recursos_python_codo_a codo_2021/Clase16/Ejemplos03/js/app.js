const ejemplo1 = new Vue({
    ...
    methods: {},
    computed: {},
   //cada vez q se ingrese algun valor WATCH se encarga
   //de actualizarlos...(observa modificaciones)
    watch: {
        //este watch observa que pasa en km
        kilometros: function(val) {
            this.kilometros = val;
            this.metros = val * 1000;
        },
        //este watch observa que pasa con metros
        metros: function(val) {
...
//Cambiando a true o false cambia
